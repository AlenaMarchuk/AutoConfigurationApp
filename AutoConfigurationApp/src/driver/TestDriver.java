...
public class TestDriver {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String fordFile = "/Users/alena/Documents/workspace/AutoModelConfigurationApp/fordFocusWagonConfigs";
			String autoFile = "/Users/alena/Documents/workspace/AutoModelConfigurationApp/testAnotherModelConfigs";
			String emptyFile = "/Users/alena/Documents/workspace/AutoModelConfigurationApp/testEmptyFile";
			String incompleteFile = "/Users/alena/Documents/workspace/AutoModelConfigurationApp/testIncompleteFile"; 

			System.out.printf("\n\tReading in data about Ford Focus\n"); 
			AutoModel ford = file.buildAutoModel(fordFile);
			System.out.printf("\n\tReading in data about another model\n"); 
			AutoModel auto = file.buildAutoModel(autoFile);
			System.out.printf("\n\tReading in an empty file.\n"); 
			AutoModel empty = file.buildAutoModel(emptyFile);
			System.out.printf("\n\n\tReading in an incomplete file.\n"); 
			AutoModel incomplete = file.buildAutoModel(incompleteFile); 

			AutoModel[] models = new AutoModel[] { auto, ford, empty, incomplete};

			System.out.printf("\n\n\t***Testing if the models are configured correctly.***\n"); 
			
			for (int x = 0; x < models.length; x++) {
				System.out.printf("\n\n\tProperties of auto model #%d\n", x + 1);
				models[x].printModelName();
				models[x].printBasePrice();
				models[x].printOptSet();
			}

			models = new AutoModel[]{auto, ford}; 
			...
			*/
			...
			AutoModel testModel = new AutoModel(); 
			...
			*/
			...
			testModel.setOptSet(numberOfConfigs);
			testModel.setAutoModelName("Test Auto Model");
			...
			*/
			...
			testModel.printOptSet(testIdx);
			testModel.printModelConfigurations();
